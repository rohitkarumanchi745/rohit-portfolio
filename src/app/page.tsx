...
const projects = [
  ...
  {
    title: "Real-time Order Fulfillment Platform",
    subtitle: "Java microservices with Spring Boot, DynamoDB streams, and React Native store operations app",
    points: [
      "Built Java Spring Boot microservices for order lifecycle management with DynamoDB as primary datastore, using GSI for query patterns and DynamoDB Streams for CDC to downstream systems.",
      "Implemented Kafka Connect with Debezium for change data capture from PostgreSQL, managing schema evolution with Confluent Schema Registry and Avro serialization.",
      "Developed React and React Native applications for store associates with real-time order updates via WebSocket, barcode scanning integration, and offline-first architecture using Redux Persist.",
      "Created SLA monitoring with custom Prometheus exporters tracking p50/p95/p99 latencies, Kafka consumer lag metrics, and automated PagerDuty escalations based on error budgets.",
      "Built blue-green deployment pipelines with Kubernetes rolling updates, Istio service mesh for traffic splitting, and automated canary analysis using Flagger.",
    ],
    stack: ["Java", "Spring Boot", "DynamoDB", "Kafka Connect", "Debezium", "Schema Registry", "React", "React Native", "WebSocket", "Prometheus", "Kubernetes", "Istio"],
    link: "#",
